 ...
 */
public class VentanaReq2 extends javax.swing.JFrame {
    ...
    public VentanaReq2() {
        ...
        modeloTabla.addColumn("Area_Max");
        modeloTabla.addColumn("No_Compras_Granito");
     ...
     */
        ...
        try {
            ...
            for (int i = 0; i < rankingProyectosGranito.size(); i++){
                
                String datos[] = new String[4];
                datos[0] = "" +rankingProyectosGranito.get(i).getIdProyecto();
                datos[1] = rankingProyectosGranito.get(i).getClasificacion();
                datos[2] = "" + rankingProyectosGranito.get(i).getAreaMax();
                datos[3] = "" + rankingProyectosGranito.get(i).getNoComprasGranito();
